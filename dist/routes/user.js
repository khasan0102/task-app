...
router.route("/create").post(photo, validator.create, auth_1.authMiddleware(false), controller.create);
router.route("/login").post(validator.login, controller.login);
router.route("/reset").post(validator.auth, controller.resetPassword);
router.route("/all").get(auth_1.authMiddleware(true), controller.getAll);
